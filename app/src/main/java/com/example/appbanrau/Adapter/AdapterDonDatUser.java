...
public class AdapterDonDatUser extends RecyclerView.Adapter<AdapterDonDatUser.ViewHolder> {


    Context context;
    List<DonDatUserDTO> list;

    public AdapterDonDatUser(Context context, List<DonDatUserDTO> list) {
